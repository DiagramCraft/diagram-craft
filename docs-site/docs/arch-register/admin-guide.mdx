...
Arch Register administration is workspace-scoped. If you want the broader explanation of what a workspace contains and how users move between workspaces, start with [Workspaces](user-guide/workspaces).

The settings screens let you manage the parts of a workspace that affect structure, access, and operational hygiene:
...
<ThemedImage
  ...
  sources={{
    light: require('/img/arch-register/settings/schema-management-light.png').default,
    dark: require('/img/arch-register/settings/schema-management-dark.png').default,
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: require('/img/arch-register/settings/teams-light.png').default,
    dark: require('/img/arch-register/settings/teams-dark.png').default,
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: require('/img/arch-register/settings/roles-permissions-light.png').default,
    dark: require('/img/arch-register/settings/roles-permissions-dark.png').default,
  }}
/>
...
<ThemedImage
  alt="AI settings"
  sources={{
    light: require('/img/arch-register/settings/ai-settings-light.png').default,
    dark: require('/img/arch-register/settings/ai-settings-dark.png').default,
  }}
/>
