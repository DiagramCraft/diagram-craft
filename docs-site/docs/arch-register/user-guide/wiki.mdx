...
<ThemedImage
  alt="Workspace wiki overview"
  sources={{
    light: require('/img/arch-register/wiki/workspace-overview-light.png').default,
    dark: require('/img/arch-register/wiki/workspace-overview-dark.png').default,
  }}
/>

<ThemedImage
  alt="Project wiki page"
  sources={{
    light: require('/img/arch-register/wiki/project-page-light.png').default,
    dark: require('/img/arch-register/wiki/project-page-dark.png').default,
  }}
/>

<ThemedImage
  alt="Entity wiki page"
  sources={{
    light: require('/img/arch-register/wiki/entity-page-light.png').default,
    dark: require('/img/arch-register/wiki/entity-page-dark.png').default,
  }}
/>
...
<ThemedImage
  alt="Markdown preview with embedded entity card"
  sources={{
    light: require('/img/arch-register/wiki/workspace-overview-light.png').default,
    dark: require('/img/arch-register/wiki/workspace-overview-dark.png').default,
  }}
...
<ThemedImage
  alt="Markdown history panel"
  sources={{
    light: require('/img/arch-register/wiki/history-light.png').default,
    dark: require('/img/arch-register/wiki/history-dark.png').default,
  }}
/>
