...
const definitionId = (
  ...
  const ids: Partial<Record<string, string>> = {
    ...
    'enum:default:vendor-category': SEED_ENUM_IDS.vendorCategory,
    'enum:default:vendor-tier': SEED_ENUM_IDS.vendorTier,
    'enum:default:vendor-status': SEED_ENUM_IDS.vendorStatus,
    'enum:default:vendor-cost-centre': SEED_ENUM_IDS.vendorCostCentre,
    'enum:default:contract-type': SEED_ENUM_IDS.contractType,
    ...
    'enum:strategy:capability-type': STRATEGY_IDS.capabilityTypeEnum,
    'enum:strategy:capability-health': STRATEGY_IDS.capabilityHealthEnum,
    'enum:strategy:strategic-importance': STRATEGY_IDS.strategicImportanceEnum,
    'enum:strategy:investment-priority': STRATEGY_IDS.investmentPriorityEnum,
    'enum:strategy:capability-reference-model': STRATEGY_IDS.capabilityReferenceModelEnum,
...
const enumOrder = [
  ...
  SEED_ENUM_IDS.capabilityType,
  SEED_ENUM_IDS.capabilityHealth,
  SEED_ENUM_IDS.strategicImportance,
  SEED_ENUM_IDS.investmentPriority,
  SEED_ENUM_IDS.capabilityReferenceModel,
