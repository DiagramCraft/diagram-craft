...
const boundaryFiles = [
  ...
  '../domain/project/db/postgresProjectCrudDatabase.ts',
  '../domain/project/db/postgresContentNodeDatabase.ts',
  '../domain/project/db/postgresMarkdownRevisionDatabase.ts',
  '../domain/project/db/postgresProjectEntityDatabase.ts',
  '../domain/project/db/postgresDiagramEntityRefDatabase.ts',
  '../domain/project/db/postgresAssessmentDatabase.ts',
  '../domain/project/db/postgresProjectMilestoneDatabase.ts',
  '../domain/project/db/postgresAssessmentResponseDatabase.ts',
