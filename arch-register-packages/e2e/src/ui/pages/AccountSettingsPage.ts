...
export class AccountSettingsPage extends WorkspacePage {
  ...
  saveChangesButton = (): Locator => this.page.getByRole('button', { name: /Save Changes|Saving\.\.\.|Saved/ });

  colorSwatch = (color: string): Locator => this.page.getByRole('button', { name: `Select color ${color}` });
