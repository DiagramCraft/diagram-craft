...
const auditLogEntrySchema = z.object({
  ...
  user_id: z
    .string()
    .nullable()
    .describe('User who performed the operation (null for system operations)'),
  user_display_name: z
    .string()
    .nullable()
    .describe('Display name of the user (null for system operations)'),
  ...
  changes: z
    .object({
      old: z
        ...
        .optional()
        .describe('Previous values before the operation'),
...
export const auditContract = oc.tag('Audit').router({
  audit: {
    list: oc
      .route({
        method: 'GET',
        ...
        description:
          'Retrieves audit log entries for the workspace with optional filtering by entity type, operation, date range, and other criteria. Results are paginated.',
        tags: ['Audit']
      })
      .input(
        z.object({
          ...
          query: z.object({
            ...
            operation: z
              .string()
              .optional()
              .describe('Filter by operation type (create, update, delete)'),
    ...
    stats: oc
      .route({
        ...
        description:
          'Retrieves statistical summary of audit log activity, including operation counts, entity type distribution, and recent activity timeline.',
        tags: ['Audit']
      })
