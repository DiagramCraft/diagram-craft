    ...
    snapshots: {
      list: oc
        .route({
          ...
          description:
            'Retrieves all snapshots for a specific entity, including autosaves, saved versions, and future updates.',
          tags: ['Entities']
        })
        .input(z.object({ params: wsAndId }))
      ...
      create: oc
        .route({
          ...
          description:
            'Creates a new snapshot of an entity, optionally with proposed changes for future updates.',
          tags: ['Entities']
        })
        .input(
          z.object({
      ...
      apply: oc
        .route({
          ...
          description:
            'Applies the proposed changes from a snapshot to the entity, updating its current state.',
          tags: ['Entities']
        })
        .input(
          z.object({
            ...
            body: z.object({
              resolvedEntityData: z
                .record(z.string(), z.unknown())
                .describe('Resolved entity data to apply')
            })
          })
        )
        .output(entitySnapshotSchema),
      restore: oc
        .route({
          ...
          description:
            'Restores an entity to a previous state from a snapshot, creating a new snapshot in the process.',
          tags: ['Entities']
        })
        .input(
          z.object({
            ...
            body: z.object({
              commitMessage: z
                .string()
                .optional()
                .describe('Commit message for the restore operation')
            })
          })
        )
        .output(entitySnapshotSchema)
