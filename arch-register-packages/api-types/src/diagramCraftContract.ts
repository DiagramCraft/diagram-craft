  ...
  diagramCraft: {
    getSchemas: oc
      .route({
        ...
        description:
          'Retrieves publicly accessible schema definitions for diagram collaboration. Used by Diagram Craft for entity integration.',
        tags: ['Diagram Craft']
      })
    ...
    getData: oc
      .route({
        ...
        description:
          'Retrieves publicly accessible entity data for diagram collaboration. Used by Diagram Craft for entity references.',
        tags: ['Diagram Craft']
      })
      .input(z.object({ params: ws }))
      .output(z.array(z.unknown())),
    ...
    generate: oc
      .route({
        ...
        description:
          'Uses AI to generate diagram content based on provided messages. Supports streaming responses for real-time generation.',
        tags: ['Diagram Craft']
      })
      .input(
        z.object({
          ...
          body: z
            .object({
              ...
              temperature: z
                .number()
                .optional()
                .describe('Temperature parameter for generation (0-2)'),
