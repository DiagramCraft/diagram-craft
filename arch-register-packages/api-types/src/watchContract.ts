...
const notificationItemSchema = z.object({
  ...
  operation: z.enum(['create', 'update', 'delete']).describe('Type of operation that triggered the notification'),
    ...
    watching: {
      list: oc
        .route({
          ...
          description: 'Retrieves all entities the current user is watching. Watched entities generate notifications when they are modified.',
          tags: ['Watch']
        })
        .input(
          z.object({
      ...
      create: oc
        .route({
          ...
          description: 'Adds an entity to the current user\'s watch list. The user will receive notifications when the entity is modified.',
          tags: ['Watch']
        })
        .input(
          z.object({
      ...
      remove: oc
        .route({
          ...
          description: 'Removes an entity from the current user\'s watch list. The user will no longer receive notifications for this entity.',
          tags: ['Watch']
        })
        .input(
          z.object({
    ...
    notifications: {
      list: oc
        .route({
          ...
          description: 'Retrieves all notifications for the current user, including changes to watched entities and other relevant updates.',
          tags: ['Watch']
        })
        .input(
          z.object({
      ...
      remove: oc
        .route({
          ...
          description: 'Marks a specific notification as read and removes it from the notification list.',
          tags: ['Watch']
        })
        .input(
          z.object({
      ...
      clear: oc
        .route({
          ...
          description: 'Marks all notifications as read and clears the notification list for the current user.',
          tags: ['Watch']
        })
        .input(
          z.object({
