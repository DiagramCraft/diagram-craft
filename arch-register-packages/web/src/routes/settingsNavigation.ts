// `schemas` and `model-overview` have dedicated static routes (settings/schemas,
// settings/model-overview) that TanStack Router matches in preference to the dynamic
// settings/$section route. Navigating to those two sections must use their own route
// template, or TanStack Router warns that the generated path doesn't match the route
