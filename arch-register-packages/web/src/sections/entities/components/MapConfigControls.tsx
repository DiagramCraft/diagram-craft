...
export const MapConfigControls = ({
  ...
  return (
    <>
      {!hideToolbar && (
        <div className={styles.hierarchyConfig}>
          <button
            type="button"
          ...
          >
            <TbChevronDown
              size={12}
              className={styles.hierarchyToggleIcon}
              data-open={hierarchyOpen ? 'true' : 'false'}
            />
                      ...
                      {index > 0 && (
                        <>
                          <button
                            ...
                            onClick={() => {
                              const nextLevels = cfg.levelConfigs.map(
