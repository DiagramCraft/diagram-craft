        ...
        <BaseUIContextMenu.Portal>
          <BaseUIContextMenu.Positioner sideOffset={2} alignOffset={-5}>
            <BaseUIContextMenu.Popup className="cmp-context-menu">
              ...
              <ActionContextMenuItem action={'SELECTION_SELECT_SHRINK'}>
                Shrink
              </ActionContextMenuItem>
        ...
        <BaseUIContextMenu.Portal>
          <BaseUIContextMenu.Positioner sideOffset={2} alignOffset={-5}>
            <BaseUIContextMenu.Popup className="cmp-context-menu">
              ...
              <ActionContextMenuItem action={'TABLE_ROW_MOVE_UP'}>
                Move row up
              </ActionContextMenuItem>
              ...
              <BaseUIContextMenu.Positioner sideOffset={2} alignOffset={-5}>
                <BaseUIContextMenu.Popup className="cmp-context-menu">
                  ...
                  {diagram.document.data.db.schemas.map(schema => {
                    return (
                      <BaseUIContextMenu.SubmenuRoot key={schema.id}>
                        <BaseUIContextMenu.SubmenuTrigger className="cmp-context-menu__sub-trigger">
                          {schema.name}
                          <div className="cmp-context-menu__right-slot">
                            <TbChevronRight />
        ...
        <BaseUIContextMenu.Portal>
          <BaseUIContextMenu.Positioner sideOffset={2} alignOffset={-5}>
            <BaseUIContextMenu.Popup className="cmp-context-menu">
              ...
              <ActionContextMenuItem action={'ALIGN_RIGHT'}>
                Align Right Edges
              </ActionContextMenuItem>
              <BaseUIContextMenu.Separator className="cmp-context-menu__separator" />
