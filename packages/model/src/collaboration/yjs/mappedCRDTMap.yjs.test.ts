...
describe('YJS MappedCRDTMap', () => {
  ...
  it('should update wrapped items correctly', () => {
    ...
    const list1 = watch<CRDTMap<any>>(doc1.getMap<MappedCRDTMapMapType<CRDTType>>('list'));
    const list2 = watch<CRDTMap<any>>(doc2.getMap<MappedCRDTMapMapType<CRDTType>>('list'));
